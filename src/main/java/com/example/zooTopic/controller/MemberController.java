...
public class MemberController {
    ...
    public ResponseEntity<Void> save(@ModelAttribute MemberDTO memberDTO) {
        ...
        headers.setLocation(URI.create("http://43.203.229.67/login"));
...
//            HttpHeaders headers = new HttpHeaders();
//            headers.setLocation(URI.create("http://43.203.229.67:3000/"));
//
//            // HTTP 상태 코드 302(Found)를 사용하여 리다이렉션을 수행
...
//            // login 실패
//            HttpHeaders headers = new HttpHeaders();
//            headers.setLocation(URI.create("http://43.203.229.67:3000/login"));
//
//            // HTTP 상태 코드 302(Found)를 사용하여 리다이렉션을 수행
//            return String.valueOf(new ResponseEntity<>(headers, HttpStatus.FOUND));
//        }
